...
//---------------------------------------------------------------------------------------------------------------------------------------------
        private static function activateDebugMode():void 
        {
				...
				DEBUG_BUTTON.graphics.lineStyle(5, 0xEEEEEE, 1, false, "none");
				DEBUG_BUTTON.graphics.beginFill(0xFFFFFF);
				DEBUG_BUTTON.graphics.drawCircle(36, 158, 25); // 40, 210
				...
				RECORD_BUTTON.graphics.lineStyle(5, 0xEEEEEE, 1, false, "none");
				RECORD_BUTTON.graphics.beginFill(0xFF0000);
				RECORD_BUTTON.graphics.drawCircle(36, 218, 25);	
				...
				PLAYBACK_BUTTON.graphics.lineStyle(5, 0xEEEEEE, 1, false, "none");
				PLAYBACK_BUTTON.graphics.drawCircle(36, 278, 25);	
...
//---------------------------------------------------------------------------------------------------------------------------------------------
		...
		{ 		
				...
				{	
					...
					DEBUG_BUTTON.graphics.lineStyle(5, 0xEEEEEE, 1, false, "none");
					DEBUG_BUTTON.graphics.drawCircle(36, 158, 25);	
					DEBUG_TEXT.x = 70;
				} else 
				{
					DEBUG_TEXT.x = STAGE.stageWidth-200;
...
//---------------------------------------------------------------------------------------------------------------------------------------------
		public static function toggleDebug(e:Event):void
		{ 	
			stopSocket(null);
			startSocket(null);		
